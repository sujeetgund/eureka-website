        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div className="text-center">
              <p className="text-xs font-semibold text-muted-foreground tracking-wide uppercase mb-6">
                To get notified aboput upcoming events and activites
              </p>
            ...
            {/* End Title */}
            {/* Avatar Group */}
            <div className="flex flex-col justify-center items-center text-center sm:text-start">
              <div className="text-lg font-semibold">
                150+ Joined Our Newsletter
              </div>
              <div className="text-sm text-muted-foreground">
                Rated best over whole campus
              </div>
            </div>
            {/* End Avatar Group */}
            {/* Form */}
